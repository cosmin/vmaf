...
float integer_rred_entropies_and_scales_avx2(const dwt2_dtype *x_t, const dwt2_dtype *y_t, size_t width,
                                        ...
                                        float *spat_scales_y, uint8_t check_enable_spatial_csf)
{
...

    {
        ...
        for(j = 1; j <= width_p1 - 16; j += 16)
        {
            ...
            __m256i to_be_stored_interim_2_x_lo_lo =
                _mm256_add_epi64(interim_2_x_4val_lo_lo,
            ...
            __m256i interim_2_x_4val_lo_hi = _mm256_loadu_si256((__m256i *) (interim_2_x + j + 4));
            __m256i to_be_stored_interim_2_x_lo_hi =
                _mm256_add_epi64(interim_2_x_4val_lo_hi,
                                 _mm256_cvtepi32_epi64(_mm256_extractf128_si256(src_xx_val_lo, 1)));
            _mm256_storeu_si256((__m256i *) (interim_2_x + j + 4), to_be_stored_interim_2_x_lo_hi);

            __m256i interim_2_x_4val_hi_lo = _mm256_loadu_si256((__m256i *) (interim_2_x + j + 8));
            __m256i to_be_stored_interim_2_x_hi_lo =
                _mm256_add_epi64(interim_2_x_4val_hi_lo,
                                 _mm256_cvtepi32_epi64(_mm256_extractf128_si256(src_xx_val_hi, 0)));
            _mm256_storeu_si256((__m256i *) (interim_2_x + j + 8), to_be_stored_interim_2_x_hi_lo);

            __m256i interim_2_x_4val_hi_hi = _mm256_loadu_si256((__m256i *) (interim_2_x + j + 12));
            __m256i to_be_stored_interim_2_x_hi_hi =
                _mm256_add_epi64(interim_2_x_4val_hi_hi,
                                 _mm256_cvtepi32_epi64(_mm256_extractf128_si256(src_xx_val_hi, 1)));
            _mm256_storeu_si256((__m256i *) (interim_2_x + j + 12), to_be_stored_interim_2_x_hi_hi);

            __m256i interim_2_y_4val_lo_lo = _mm256_loadu_si256((__m256i *) (interim_2_y + j));
            __m256i to_be_stored_interim_2_y_lo_lo =
                _mm256_add_epi64(interim_2_y_4val_lo_lo,
            ...
            __m256i interim_2_y_4val_lo_hi = _mm256_loadu_si256((__m256i *) (interim_2_y + j + 4));
            __m256i to_be_stored_interim_2_y_lo_hi =
                _mm256_add_epi64(interim_2_y_4val_lo_hi,
                                 _mm256_cvtepi32_epi64(_mm256_extractf128_si256(src_yy_val_lo, 1)));
            _mm256_storeu_si256((__m256i *) (interim_2_y + j + 4), to_be_stored_interim_2_y_lo_hi);

            __m256i interim_2_y_4val_hi_lo = _mm256_loadu_si256((__m256i *) (interim_2_y + j + 8));
            __m256i to_be_stored_interim_2_y_hi_lo =
                _mm256_add_epi64(interim_2_y_4val_hi_lo,
                                 _mm256_cvtepi32_epi64(_mm256_extractf128_si256(src_yy_val_hi, 0)));
            _mm256_storeu_si256((__m256i *) (interim_2_y + j + 8), to_be_stored_interim_2_y_hi_lo);

            __m256i interim_2_y_4val_hi_hi = _mm256_loadu_si256((__m256i *) (interim_2_y + j + 12));
            __m256i to_be_stored_interim_2_y_hi_hi =
                _mm256_add_epi64(interim_2_y_4val_hi_hi,
                                 _mm256_cvtepi32_epi64(_mm256_extractf128_si256(src_yy_val_hi, 1)));
            _mm256_storeu_si256((__m256i *) (interim_2_y + j + 12), to_be_stored_interim_2_y_hi_hi);
        }
        for(; j < width_p1; j++)
        {
            int j_minus1 = j - 1;
