                   ...
                   unsigned index, VmafFeatureCollector *feature_collector)
{
    ...
    if (s->enable_spatial_csf) {
        ...
        s->modules.integer_funque_dwt2_wavelet(res_ref_pic->data[0], &s->i_ref_dwt2out, s->i_dwt2_stride, res_ref_pic->w[0], res_ref_pic->h[0]);
        s->modules.integer_funque_dwt2_wavelet(res_dist_pic->data[0], &s->i_dist_dwt2out, s->i_dwt2_stride, res_dist_pic->w[0], res_dist_pic->h[0]);
    }
